...
In the scope of this "OrderService.API" We couldn't really showcase this pattern. Because we will need at least 2 micro-services (Or you can try to run 2 different instances of the "OrderService.API")
